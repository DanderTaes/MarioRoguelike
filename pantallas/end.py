...
class End:
    ...
    def update(self): # para que no de error al ejecutar update en todas las pantallas
        pass
    ...
    def draw(self):
        ...
        for text, yposition in zip(texts, ypositions):
            # Si lo que se imprime es la puntación del usuario, hacer que cambie de color entre todos los colores menos el negro
            color = lambda text: pyxel.frame_count % 15 + 1 if (text == str(self.score)) else 10 
